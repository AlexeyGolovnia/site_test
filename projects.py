projects = [
    ...
    {
        "name": "<a href='https://github.com/AlexeyGolovnia/outflow-of-telecom-customers-prediction' target='_blank'>Spark Pipeline</a>",
        "description": "\
    This educational project involves building a data processing pipeline in PySpark and subsequently training a model with automatic hyperparameter tuning.\
    The project utilizes PySpark to construct a robust pipeline that handles data preprocessing, feature engineering, model training, and evaluation.\
    Automatic hyperparameter tuning ensures optimal model performance without manual intervention.",
        "date": "Dec 2023",
        "tools": "- Python,- Spark,- PySpark MLlib",
    },

    {
        "name": "<a href='https://github.com/AlexeyGolovnia/revenue-prediction' target='_blank'>Kaggle Competition</a>",
        "description": "\
    In this Kaggle competition, I employed various techniques with basic machine learning models.\
    I extensively utilized the scikit-learn library, implementing data processing pipelines, training multiple models with hyperparameter tuning, and selecting the optimal model through ensemble voting.\
    This project sharpened my skills in data preprocessing, model selection, and ensemble learning techniques, demonstrating proficiency in leveraging machine learning for competitive data science challenges on Kaggle.",
        "date": "Nov 2023",
    ...
    {
        "name": "<a href='https://github.com/AlexeyGolovnia/de_course' target='_blank'>Data Preparation</a>",
        "description": "\
    This educational project focuses on data preparation, involving key steps such as data preprocessing, integration of data from various sources, and populating a database with prepared data.\
    The project is implemented using Apache Airflow, which orchestrates and automates these data pipeline tasks.\
    By leveraging Airflow, I ensured efficient data management and integration, enhancing my skills in workflow orchestration and data engineering practices.",
        "date": "Aug 2022,Oct 2022",
        "tools": "- Python,- Apache Airflow,- PostgreSQL,- Sqlalchemy,- Docker",
    },
